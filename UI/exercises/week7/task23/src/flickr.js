...
var link =
  ...
  export function getPhotoSizes(num, id, caption) {
    var l =
    ...
    $.get(l, function (data) {
      ...
      AppendMeme(num, id, item,lstPhotoStore);
    });
  }
  ...
  export function searchBtn() {
    //https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=3f412037b4ba4ca3d7652e993ed5c5c1&text=&format=json&nojsoncallback=1&auth_token=72157718905370125-6bfdc43fa9d6f81b&api_sig=c0ee85cfb68ddac7190c0f533a1f153f
    ...
    var l =
      ...
      flickr_key +
      "&format=json&nojsoncallback=1&per_page=5&text=" +
      txt +
      "&" +
      parms;
